[README.md](https://github.com/user-attachments/files/30249293/README.md)
...
<!-- Insira aqui o print do site ANTES (arquivo original) -->
`screenshots/index-antes.png`

<!-- Insira aqui o print do site DEPOIS (versão Bootstrap) -->
`screenshots/index-depois.png`
...
`screenshots/biblioteca-antes.png`
`screenshots/biblioteca-depois.png`
...
`screenshots/cursos-antes.png`
`screenshots/cursos-depois.png`
...
`screenshots/resultados-antes.png`
`screenshots/resultados-depois.png`
...
`screenshots/livros-depois.png`
`screenshots/artigos-depois.png`
...
`screenshots/servicos-antes.png`
`screenshots/servicos-depois.png`
